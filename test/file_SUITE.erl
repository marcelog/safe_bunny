...
complete_coverage(_Config) ->
  {noreply, state} = safe_bunny_producer_file:handle_cast(msg, state),
  {noreply, state} = safe_bunny_producer_file:handle_info(info, state),
  {reply, {invalid_request, unknown}, state} = safe_bunny_producer_file:handle_call(unknown, from, state),
  {ok, state} = safe_bunny_producer_file:code_change(oldvsn, state, extra),
  ok = safe_bunny_producer_file:terminate(reason, state),
